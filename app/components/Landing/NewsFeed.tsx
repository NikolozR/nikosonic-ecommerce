    ...
    <section className="mb-[40px]">
        <div className="container">
            <div className="py-[40px]">
                <h1 className="text-[#6C7275] font-bold text-[1rem] text-center mb-[16px]">NEWSFEED</h1>
                <h4 className="font-poppins font-medium text-[2.5rem] leading-[44px] text-center" style={{letterSpacing: '-0.4px'}}>Instagram</h4>
                <p className="text-[1.125rem] text-[#121212] mt-[16px] leading-[32px] text-center">Follow us on social media for more discount & promotions</p>
                <a href="https://www.instagram.com/nika_rusishvili/" target="_blank" className="text-[#6C7275] block text-center font-poppins font-medium text-[1.125rem] leading-[28px] mt-[16px]">@nika_rusishvili</a>
            </div>
