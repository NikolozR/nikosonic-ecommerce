        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-[24px] w-full h-[664px]">
            <div className="bg-[#F3F5F7] relative row-span-2">
                ...
                <div className="absolute bottom-[20px] left-[20px] flex flex-col gap-[12px]">
                    ...
                    <Link href={'/products?categories=headband'} className="border-b-[1px] border-solid border-[#121212] flex w-fit pb-[4px] gap-[5px] font-medium text-[1rem] text-[#121212]">Collection <FaArrowRight /> </Link>
                </div>
            </div>
            <div className="bg-[#F3F5F7] relative">
                ...
                <div className="absolute bottom-[20px] left-[20px] flex flex-col gap-[12px]">
                    ...
                    <Link href={'/products?categories=earbud'} className="border-b-[1px] border-solid border-[#121212] flex w-fit pb-[4px] gap-[5px] font-medium text-[1rem] text-[#121212]">Collection <FaArrowRight /> </Link>
                </div>
            </div>
            <div className="bg-[#F3F5F7] relative">
                ...
                <div className="absolute bottom-[20px] left-[20px] flex flex-col gap-[12px]">
                    ...
                    <Link href={'/products?categories=earphone'} className="border-b-[1px] border-solid border-[#121212] flex w-fit pb-[4px] gap-[5px] font-medium text-[1rem] text-[#121212]">Collection <FaArrowRight /> </Link>
                </div>
            </div>
