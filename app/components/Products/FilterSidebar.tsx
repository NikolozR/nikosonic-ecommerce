...
function FilterSidebar({ brands }: { brands: string[] }) {
  return (
    <div className="w-[15%] mb-[100px]">
      ...
      <Button handleClick={handleReset} type="button" fontSize="0.8rem" padding="px-2 py-2" className="flex items-center gap-[4px] !text-[#003285] justify-between bg-[#FFAB00A3]"><FaRegTrashAlt />Clear</Button>
      </div>
      <div>
        <div>
        ...
        <div>
          <h3 className="text-[#121212] font-bold text-[1rem] leading-[26px] mt-[32px] mb-[12px]">BRANDS</h3>
          <div className="flex flex-col gap-[8px]">
            {brands.map((brand, i) => {
              return (
                <FilterCheckbox
