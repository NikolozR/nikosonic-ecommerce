...
function SideDetails({ product, user }: { product: Product; user: User }) {
  return (
    <div className="flex flex-col gap-[32px] w-full md:w-[40%] lg:w-fit">
      <div className="flex gap-[10px]">
        ...
        <span className="text-[0.75rem] leading-[20px] text-[#141718] dark:text-[#ECEDEE]">
      ...
      <p className="text-[#6C7275] lg:max-w-[40ch] text-[0.75rem] lg:text-[1rem] leading-[26px]">
        {product.description}
      </p>
      ...
      <div className="w-fit">
        <h3 className="text-[#141718] font-bold text-[1.2rem] py-[16px] dark:text-[#ECEDEE]">
          Charachteristics
        </h3>
        <div className="grid grid-cols-2 gap-x-[50px] gap-y-[20px]">
          <span className="flex items-center gap-[10px] font-bold">
            <span className="text-[#6C7275] text-[0.75rem] lg:text-[1.1rem] font-normal">
              Category:
            </span>
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-[25px] items-center">
        {user ? (
