...
export default function AuthorizeModal() {
  ...
  return (
    <>
      <button
        className={
          `w-fit px-[74px] transition-all z-50 group-hover:opacity-100 ease-in-out duration-[0.3s] absolute bottom-[0px] left-[50%] text-nowrap translate-x-[-50%] opacity-0  py-[9px] text-[1rem] bg-[#141718] text-white rounded-[8px] group-hover:bottom-[25px]`
        }
        type="button"
        onClick={(e) => {
          e.stopPropagation();
