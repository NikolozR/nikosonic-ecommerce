...
function LocaleSwitcher() {
  ...
  return (
    <Dropdown classNames={{
      ...
      <DropdownTrigger>
        <Button variant="bordered" className="dark:border-[white] text-[0.75rem] lg:text-[1rem] border-black border-1 h-[30px] lg:h-10 text-black dark:text-[white] px-0 py-0">
